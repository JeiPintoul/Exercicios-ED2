...
public class BST {
    ...
    public boolean checarEquidade(BST arvoreComparada) {
        return checarEquidade(this.raiz, arvoreComparada.raiz);
    }

    private boolean checarEquidade(No noRaizOriginal, No noRaizComparado) {
        if (noRaizOriginal == null && noRaizComparado == null) {
            return true;
        }
        ...
        if (noRaizOriginal.valor != noRaizComparado.valor) {
            return false;
        }

        return checarEquidade(noRaizOriginal.esq, noRaizComparado.esq) && checarEquidade(noRaizOriginal.dir, noRaizComparado.dir);
    }
}

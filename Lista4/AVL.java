...
public class AVL {
    ...
    public void inserir(int valor) {
        System.out.println("Inserindo o nó de valor: " + valor);
    ...
    private No inserir(No no, int valor) {
        ...
        atualizarAltura(no);
        System.out.println("Fator de balanceamento do nó de valor  " + valor + ": " + getFatorBalanceamento(no));
    ...
    private No rebalancear(No no) {
        ...
        System.out.println("Nenhuma rotação necessária em: " + no.valor);
